        ...
        <div id="mainmiddle" class="floatbox withright">
          ...
          <div class="welcome">
            ...
            <p style="width: 452px" class="style1">&nbsp;</p>
						<p style="width: 452px" class="style1"><em><strong>Search your Leader By Age Range</strong></em></p>
            ...
            <form name="search-form" action="MPServlet" method="post">
                    ...
                    <input type="text" id="search" name="min" style="left: 160px; top: 260px; width: 150px" />
                    <input type="text" id="search" name="max" style="left: 340px; top: 260px; width: 150px" />
                   <input type="hidden" name="pagename" value="age"/>
                    <input type="submit" id="search-submit" value="" style="left: 500px; top: 250px;" />
